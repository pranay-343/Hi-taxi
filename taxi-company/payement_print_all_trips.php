        ...
        <div class="c-acc-status mg0">
          <h2 class="txt-style-3">View Message </h2>
            ...
            <?php 
                ...
                $str="select * from driver_trip_payment where 1 and driver_id='$id' and added_on  LIKE  '%$curr_date%' ";
                $res=mysql_query($str);
                $rowD=mysql_fetch_array($res);
                
                $str11="select * from driver_trip_payment where 1 and driver_id='$id' and added_on  LIKE  '%$curr_date%' ";
                $res11=mysql_query($str11);
                    
                $data_com = mysql_fetch_array(mysql_query("SELECT * FROM driver WHERE id = '".$rowD['driver_id']."'"));
                $name = $data_com['name'];
          ...
          <div class="row bts">
              ...
              <div class="c-acc-status bst mgmin">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0" class="ctabel1">
                        <tr> 
                            ...
                            <th class="tab-txt1">Identificaci&ograve;n del viaje</th>
                            <th class="tab-txt1">A&ntilde;adido el</th>                          
                            <th class="tab-txt1">M&Atilde;?S INFORMACIÓN</th>
                         </tr>
                      ...
                      <tr> 
                          ...
                          <td class="tab-txt1"><?php echo CURRENCY.$row['amount'];?></td>
                          <td class="tab-txt1"><?php echo $row['trip_id'];?></td>
                          <td class="tab-txt1"><?php echo date('Y-m-d', strtotime($row['added_on']));?></td>
                          <td class="tab-txt1"><a href="view-taxi-driver-info.php?id=<?php echo base64_encode($row['trip_id']);?>"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                      </tr>
                      <?php }?>
                  </table>
              ...
              <div class="c-acc-status bst mgmin" id="content" style="display :none">
                  <h2 class="txt-style-3">Payment Information</h2>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0" class="ctabel1">
                      ...
                      <?php while($rowDDD = mysql_fetch_array($res11)){ ?>  
                      <tr> 
                          <td class="tab-txt1"><?php echo $_SESSION['uname'];?></td>
                          <td class="tab-txt1"><?php echo $name;?></td>
                          <td class="tab-txt1"><?php echo CURRENCY.$rowDDD['amount'];?></td>
                          <td class="tab-txt1"><?php echo $rowDDD['trip_id'];?></td>
                          <td class="tab-txt1"><?php echo date('Y-m-d', strtotime($rowDDD['added_on']));?></td>
                      </tr>
                      <?php }?>
                  </table>
                    <!-- date and signtaure Starts -->   
