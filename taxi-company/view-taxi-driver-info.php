...
{
	RedirectURL(TAXI_URL."view-taxi-driver.php");
}
        ...
        <div class="row">
          ...
          <div class="col-sm-9">
            <div class="c-acc-status">
              <h2 class="txt-style-3">Driver detail</h2>
              <div class="row">
              	<div class="col-sm-3">
                	<span class="txt-style-4">Taxi Driver : <b><?php echo $data['drivername'];?></b></span>
                    <div class="driver-image"><img src="<?php echo $imgDriver;?>" alt="" title="" /></div>
                </div>
                <div class="col-sm-2">
                <span class="txt-style-4">Source Address : <b><?php echo $data['source_address'];?></b></span>
                </div>

                <div class="col-sm-2">
                <span class="txt-style-4">Destination Address : <b><?php echo $data['destination_address'];?></b></span>
                </div>
                <!-- <div class="col-sm-4">
