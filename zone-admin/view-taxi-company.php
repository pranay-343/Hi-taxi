    ...
    <div class="row">
      ...
      <div class="col-sm-9 mg5">
        ...
        <div class="c-acc-status mg0">
          ...
          ?>
          <div class="comm_bal">
          <p class="bal_setting">The total balance of the company  : <?php echo CURRENCY.$data_total_bal['total_amt'];?></p>
          <p class="bal_setting">The actual balance  : <?php //echo CURRENCY.$data_total_bal['total_amt'];?></p>
          <a href="<?php echo MAIN_URL?>zone-admin/account-status.php"><input type="submit" name="account" id="update_central" value="Account Status" class="dash-button hvr-wobble-horizontal w10 wap wer" style="margin-bottom:17px;"></a>
            ...
            <div class="row bts">
              <div class="col-sm-4">
                <div class="form-group">
                  <label>Name</label>
                  <input type="text" name="Company_name" id="Company_name" class="input-style input-style1" placeholder="Introduzca texto aquí" value="<?php echo $taxicomDetail['name']?>" readonly/>
                </div>
              </div>
              <div class="col-sm-4">
                <div class="form-group">
                  <label>Address</label>
                  <input type="text" name="address" id="address" class="input-style input-style1" placeholder="Introduzca texto aquí" value="<?php echo $taxicomDetail['address']?>" readonly/>
                </div>
              </div>              
              <div class="col-sm-4">
                <div class="form-group">
                  <label>COUNTRY</label>
                  <input type="text" name="country" id="country" class="input-style input-style1" placeholder="Enter Country Here" required value="<?php echo $taxicomDetail['country'];?>" readonly/>
                </div>
              </div>
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type="text" name="contactno" id="contactno"  class="input-style input-style1" placeholder="Introduzca texto aquí" value="<?php echo $taxicomDetail['contact_number']?>" onKeyPress="return IsNumeric(event);"/>
                  <span id="error" style="color: Red; display: none">Type Numbers (0 - 9)</span>
                </div>
              </div>
              <div class="col-sm-4">
                <div class="form-group">
                  <label>PER WEEK ACTIVATION COST</label>
                  <input type="txt" name="per_week_cost" id="per_week_cost" class="input-style input-style1" style="color:#999;" placeholder="Introduzca texto aquí"  onkeypress="return IsNumeric(event);" value="<?php echo $taxicomDetail['per_week_cost']?>">
...
<!--                  <input type="text" name="worklimit" id="worklimit" class="input-style" placeholder="Introduzca texto aquí"  onkeypress="return IsNumeric(event);" value="<?php echo $taxicomDetail['work_limit']?>"/>
                  ...
                  <select name="worklimit" id="worklimit" class="input-style input-style1">
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type="text" name="emailID" class="input-style input-style1" placeholder="Email Id" value="<?php echo $data1['email']?>" required/>
                </div>
              </div>
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input type="passowrd" name="passowrd" id="passowrd" class="input-style input-style1" placeholder="Enter passowrd Here" required value="<?php echo $data1['password_de'];?>" readonly/>
                </div>
              </div> 
         ...
         <div class="col-sm-12">
           ...
           <!-- <div class="row">
              <!--<div class="col-sm-4 col-sm-offset-2">
                <button class="dash-button hvr-wobble-horizontal w100">add files</button>
              </div>
              <div class="col-sm-4">                  
                  ...
                  <!--<input type="submit" name="update_central" id="update_central" value="save" class="dash-button hvr-wobble-horizontal w100" />
              </div>
            </div>-->
          </form>
          </div>
