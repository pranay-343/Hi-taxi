...
// $driver_id = '28';
 ...
 $row900=mysql_fetch_assoc($res900);
	if($row900['zone_id'] == '0')
	{
		...
		$query_taxi_com = "SELECT driver.company_id,driver.zone_id,taxicompany.zone_area_id_sess FROM driver LEFT JOIN taxicompany ON driver.company_id = taxicompany.web_user_id WHERE driver.id ='$driver_id'";
		...
		$zone_id = $data_taxi_com['zone_area_id_sess'];
